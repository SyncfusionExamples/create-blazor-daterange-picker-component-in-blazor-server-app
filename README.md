...
The [appearance](https://blazor.syncfusion.com/documentation/daterangepicker/style-appearance?utm_source=github&utm_medium=listing&utm_campaign=blazor-date-range-picker-github-samples) of the component can be completely changed. Customize the application’s look and feel according to the requirement.

### Week number

Show the [week numbers](https://blazor.syncfusion.com/documentation/daterangepicker/week-number?utm_source=github&utm_medium=listing&utm_campaign=blazor-date-range-picker-github-samples) in the pop-up calendar.
...
[Online Examples](https://blazor.syncfusion.com/demos/daterangepicker/default-functionalities?theme=bootstrap5?utm_source=github&utm_medium=listing&utm_campaign=blazor-date-range-picker-github-samples) <br/><br/>
